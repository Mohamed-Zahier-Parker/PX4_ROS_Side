...
(defsystem "mavros_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "MPC_Inputs" :depends-on ("_package_MPC_Inputs"))
    (:file "_package_MPC_Inputs" :depends-on ("_package"))
    (:file "MPC_Outputs" :depends-on ("_package_MPC_Outputs"))
    (:file "_package_MPC_Outputs" :depends-on ("_package"))
