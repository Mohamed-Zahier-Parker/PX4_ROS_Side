...
TEST(common, MPC_INPUTS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::MPC_INPUTS packet_in{};
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.mpc_ref_in = {{ 73.0, 74.0, 75.0, 76.0, 77.0, 78.0, 79.0, 80.0, 81.0, 82.0, 83.0, 84.0, 85.0, 86.0, 87.0, 88.0, 89.0, 90.0, 91.0, 92.0, 93.0, 94.0, 95.0, 96.0, 97.0, 98.0, 99.0, 100.0, 101.0, 102.0, 103.0, 104.0, 105.0, 106.0, 107.0, 108.0, 109.0, 110.0 }};
    packet_in.mpc_mo_in = {{ 1137.0, 1138.0 }};

    mavlink::common::msg::MPC_INPUTS packet1{};
    mavlink::common::msg::MPC_INPUTS packet2{};
    ...
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.mpc_ref_in, packet2.mpc_ref_in);
    EXPECT_EQ(packet1.mpc_mo_in, packet2.mpc_mo_in);
}

#ifdef TEST_INTEROP
TEST(common_interop, MPC_INPUTS)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_mpc_inputs_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.mpc_ref_in, packet2.mpc_ref_in);
    EXPECT_EQ(packet_in.mpc_mo_in, packet2.mpc_mo_in);
...
TEST(common, MPC_OUTPUTS)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::MPC_OUTPUTS packet_in{};
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.mpc_mv_out = {{ 73.0, 74.0 }};

    mavlink::common::msg::MPC_OUTPUTS packet1{};
    mavlink::common::msg::MPC_OUTPUTS packet2{};
    ...
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.mpc_mv_out, packet2.mpc_mv_out);
}

#ifdef TEST_INTEROP
TEST(common_interop, MPC_OUTPUTS)
{
    mavlink_message_t msg;
    ...
    mavlink_mpc_outputs_t packet_c {
    ...
    mavlink_msg_mpc_outputs_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.mpc_mv_out, packet2.mpc_mv_out);
